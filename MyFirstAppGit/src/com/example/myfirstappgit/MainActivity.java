...
public class MainActivity extends Activity {
    ...
    protected void onNewIntent(Intent intent) {
        ...
        if (i != null)
        {
            ...
            oneMessageNotification(message, sender);
            if (message != null)
            {
                storedMessages.add(message);
                String[] messageArray = listToArray(storedMessages);
    ...
    protected void oneMessageNotification(String message, String sender)
    {
        ...
        mNotificationManager.notify(R.id.oneMsgNoti, noti.build());
    }
